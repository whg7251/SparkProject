 ...
 * 模拟数据  数据格式如下：
 * 
 *  日期  卡口ID     摄像头编号  车牌号	   拍摄时间	     车速	 道路ID   	 域ID
...
//     	String[] areas = new String[]{"海淀区","朝阳区","昌平区","东城区","西城区","丰台区","顺义区","大兴区"};
    	...
    	for (int i = 0; i < 3000; i++) {
        	...
        	String baseActionTime = date + " " + StringUtils.fulfuill(random.nextInt(24)+"");//2019-01-01 20
        	/**
        	...
        	for(int j = 0 ; j < (random.nextInt(300)+1) ; j++){
        		...
        		String actionTime = baseActionTime + ":" 
        				...
        				+ StringUtils.fulfuill(random.nextInt(60)+"");//模拟经过此卡扣开始时间 ，如：2019-01-01 09:20:10
    	...
    	/**
    	 * 2019-01-01 1	22	京A1234
    	 * 2019-01-01 1	23	京A1234
    	 * 1 【22,23】
    	 * 1 【22,23,24】
    	 */
