...
import com.guo.spark.domain.CarTrack;
import com.guo.spark.domain.RandomExtractCar;
...
import com.guo.spark.domain.RandomExtractMonitorDetail;
	...
	private static JavaPairRDD<String, Row> randomExtractCarInfo(
		...
		JavaPairRDD<String, String> dateHourCar2DetailRDD = cameraRDD.mapToPair(new PairFunction<Row, String,String>() {
			...
			public Tuple2<String, String> call(Row row) throws Exception {
				String actionTime = row.getString(4);//2019-01-02 06:18:49
				String dateHour = DateUtils.getDateHour(actionTime);//2019-01-02_06
